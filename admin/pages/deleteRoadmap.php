...
<head>
    ...
    <title>Delete a Main Roadmap</title>
...
<body class="bg-gradient-primary">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <!-- 
                                        ...
                                        type
                                     -->
                                    <form class="user" action="../determination/roadmaps/DeleteRoadmapSystem.php" method="POST">
  ...
  <tbody>
    ...
    $users = mysqli_query($conn, "SELECT * FROM `roadmaps`");
